  ...
  return (
    <section className={styles.section}>
      ...
      <p className={styles.p}>
        ...
        <span className={styles.info}>February 2023</span>, it was confirmed by
        Supercell in the last one.
      </p>
      <p className={styles.p}>
        What is going to contain?. We don&apos;t know yet but one feature that
        probably will be added is
        <span className={styles.info}> masteries </span>
        because we had a little skeak peek in The Brawlies 2022 and it was a
        thing that they wanted to add as they told ous in season 14 Brawl Talk.
      </p>
