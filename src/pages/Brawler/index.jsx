                ...
                <div key={star.id}>
                  <div className={styles.starCont}>
                    <Image
                      ...
                      priority={false}
                    />
                    <p className={`${styles.starName} ${styles.starColor}`}>{star.name}</p>
                  </div>
      ...
      <div className={styles.statsCont}>
        <div>
          ...
          <div className={styles.selectCont}>
            <h3 onClick={() => setSelect(true)} className={`${styles.select} ${select && styles.selected}`}>
              Most Used
            </h3>
            <h3 onClick={() => setSelect(false)} className={`${styles.select} ${!select && styles.selected}`}>
              Win Rate
            </h3>
          </div>
          <div className={styles.brawlersCont}>
            {select
              ? mostUsed.map((brawl, index) => {
                  return (
                    <div
                      className={`${styles.div} ${index % 2 === 0 ? styles.even : styles.odd} ${
                        brawler.name.toUpperCase() === brawl.name && styles.sameBrawler
                      }`}
                      key={brawl.name}
                    >
                      <div className={styles.brawlStats}>
                        <div
                          className={`${styles.positionCenter} ${
                            brawler.name.toUpperCase() === brawl.name && styles.brawlerIndexCont
                          }`}
                        >
                          <h3
                            className={`${styles.position} ${
                              brawler.name.toUpperCase() === brawl.name && styles.brawlerIndex
                            }`}
                          >
                            {index + 1}
                          </h3>
        ...
        <div>
          ...
          <h4 className={styles.order}>Order By:</h4>
          <div className={styles.selectCont}>
            <h3 onClick={() => setSelectSd(true)} className={`${styles.select} ${selectSd && styles.selected}`}>
              Most Used
            </h3>
            <h3 onClick={() => setSelectSd(false)} className={`${styles.select} ${!selectSd && styles.selected}`}>
              Win Rate
            </h3>
          </div>
          <div className={styles.brawlersCont}>
